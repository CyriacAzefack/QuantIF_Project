...
public class Mask {
     ...
     */
    public Mask(Patient patient, String maskDirPath) throws BadParametersException, NotDirectoryException {
        if (patient == null)
        ...
        this.maskImages = analyseDirectory(maskDirPath);
     ...
     */
    private ArrayList<BufferedImage> analyseDirectory(String dirPath) throws NotDirectoryException {
                    ...
                    try {
                        ...
                        for (int row = 0; row < this.width; ++row) {
                            ...
                            for (int col = 0; col < this.height; ++col) {   
                               ...
                               if (data[row][col] == 1) {
                                    bimg.setRGB(col, row, Color.red.getRGB());
